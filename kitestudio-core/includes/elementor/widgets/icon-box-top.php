...
class Kite_Icon_Box_Top_Widget extends \Elementor\Widget_Base {

	/**
	 * Get widget name.
	 *
	 * Retrieve Icon Box Top widget name.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_name() {
		return 'kite-icon-box-top';
	}

	/**
	 * Get widget title.
	 *
	 * Retrieve Icon Box Top widget title.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'Icon Box Top', 'kitestudio-core' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Icon Box Top widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_icon() {
		return 'eicon-text-align-center kite-element-icon';
	}

	/**
	 * Get widget categories.
	 *
	 * Retrieve the list of categories the Icon Box Top widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	/**
	 * Register Icon Box Top widget controls.
	 *
	...
	protected function register_controls() {
		$this->start_controls_section(
			'content_section',
			array(
				'label' => esc_html__( 'Icon Box Top', 'kitestudio-core' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'right_alignment'  => esc_html__( 'Right', 'kitestudio-core' ),
					'center_alignment' => esc_html__( 'Center', 'kitestudio-core' ),
					'left_alignment'   => esc_html__( 'Left', 'kitestudio-core' ),
				),
				'default' => 'right_alignment',
			)
		);
		$this->add_control(
			'alignment_resp',
			array(
				'label'   => esc_html__( 'Icon Alignment in Mobile', 'kitestudio-core' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'center_mob' => esc_html__( 'Center', 'kitestudio-core' ),
					'right_mob'  => esc_html__( 'Right', 'kitestudio-core' ),
					'left_mob'   => esc_html__( 'Left', 'kitestudio-core' ),
				),
				'default' => 'center_mob',
			)
		);
	...
	/**
	 * Render Icon Box Top widget output on the frontend.
	 *
	...
	protected function render() {
		...
		$atts = [
			...
			'alignment_resp' =>  $settings['alignment_resp']  ,
			'url' =>  $settings['url']  ,
		...
		echo kite_sc_iconbox_noborder( $atts );
	}
