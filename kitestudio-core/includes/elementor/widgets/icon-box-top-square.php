<?php
/**
 * Elementor Icon Box Square Widget.
 *
 * @since 1.0.0
 */
...
class Kite_Icon_Box_Square_Widget extends \Elementor\Widget_Base {

	/**
	 * Get widget name.
	 *
	 * Retrieve Icon Box Square widget name.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_name() {
		return 'kite-icon-box-square';
	}

	/**
	 * Get widget title.
	 *
	 * Retrieve Icon Box Square widget title.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'Icon Box Top Square', 'kitestudio-core' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Icon Box Square widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_icon() {
		return 'eicon-fb-feed kite-element-icon';
	}

	/**
	 * Get widget categories.
	 *
	 * Retrieve the list of categories the Icon Box Square widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	/**
	 * Register Icon Box Square widget controls.
	 *
	...
	protected function register_controls() {
		$this->start_controls_section(
			'content_section',
			array(
				'label' => esc_html__( 'Icon Box - Top Square', 'kitestudio-core' ),
	...
	/**
	 * Render Icon Box Square widget output on the frontend.
	 *
	...
	protected function render() {
		...
		echo kite_sc_iconbox_rectangle( $atts );
	}
