...
class Newsletter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Header - Newsletter', 'kitestudio-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'icon',
			array(
				'label'   => esc_html__( 'Newsletter Icon', 'kitestudio-core' ),
		...
		$this->add_control(
			'icon_subtitle',
			array(
				'label' => esc_html__( 'Newsletter Icon Subtitle', 'kitestudio-core' ),
		...
		$this->add_control(
			'title',
			array(
				'label' => esc_html__( 'Newsletter Icon Title', 'kitestudio-core' ),
				'type'  => Controls_Manager::TEXT,
			)
		);
